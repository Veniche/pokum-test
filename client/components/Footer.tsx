            ...
            <div className="w-[1192px] h-[270px] absolute left-[120px] top-[116px]">
              ...
              <div className="inline-flex items-center gap-5 absolute left-[1236px] top-[30px] w-[156px] h-6">
                <div className="flex items-center gap-5">
                  <div className="flex w-6 h-6 justify-center items-center rounded-[30000px]">
                    <a
                      href="#"
                      className="flex w-6 h-6 justify-center items-center aspect-square rounded-[30000px]"
                    >
                      <img
                        src="/pokum/icons/facebook.svg"
                        alt="Facebook"
                        className="w-6 h-6"
                      />
                    </a>
                  ...
                  <div className="flex w-6 h-6 pr-[0.023px] justify-center items-center rounded-[30000px]">
                    <a
                      href="#"
                      className="flex w-6 h-6 flex-col justify-center items-center aspect-[23.98/24.00]"
                    >
                      <img
                        src="/pokum/icons/twitter.svg"
                        alt="Twitter"
                        className="w-6 h-6"
                      />
                    </a>
                  ...
                  <div className="flex w-6 h-6 justify-center items-center rounded-[30000px]">
                    <a
                      href="#"
                      className="flex w-6 h-6 justify-center items-center aspect-square"
                    >
                      <img
                        src="/pokum/icons/instagram.svg"
                        alt="Instagram"
              ...
              <div className="inline-flex flex-col items-start gap-7 absolute left-0 top-[69px] w-[453px] h-[201px]">
                <div className="flex items-center gap-3">
                  ...
                  >
                    <path
                      d="M2.5013 2.50269H17.5013C17.7223 2.50269 17.9343 2.59048 18.0906 2.74676C18.2468 2.90304 18.3346 3.11501 18.3346 3.33602V16.6694C18.3346 16.8904 18.2468 17.1023 18.0906 17.2586C17.9343 17.4149 17.7223 17.5027 17.5013 17.5027H2.5013C2.28029 17.5027 2.06833 17.4149 1.91205 17.2586C1.75577 17.1023 1.66797 16.8904 1.66797 16.6694V3.33602C1.66797 3.11501 1.75577 2.90304 1.91205 2.74676C2.06833 2.59048 2.28029 2.50269 2.5013 2.50269ZM10.0513 9.73852L4.70797 5.20102L3.6288 6.47102L10.0621 11.9335L16.3796 6.46685L15.2896 5.20602L10.0513 9.73852Z"
                      fill="white"
                      fillOpacity="0.7"
                    />
                  </svg>
